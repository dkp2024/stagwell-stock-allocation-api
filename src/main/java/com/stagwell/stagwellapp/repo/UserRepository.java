...
extends JpaRepository<SwmUserInfo, Integer> {
    ...
    public void saveSwtSpecialRequests(SpecialRequestDto var1);
    ...
    public List<Map<String, Object>> getSpecialRequests(int var1);
    ...
    public void saveEntity(UserEntityDto var1);
    ...
    public void updateSpecialRequestWithApprovedSRValues(SpecialRequestApproveDto var1);

    @Modifying
    @Query(nativeQuery=true, value="UPDATE swt_special_requests SET \napproval_status=:#{#sr.approvalStatus} WHERE special_request_id=:#{#sr.specialRequestId}")
    public void updateSpecialRequestWithoutApprovedSRValues(SpecialRequestApproveDto var1);
